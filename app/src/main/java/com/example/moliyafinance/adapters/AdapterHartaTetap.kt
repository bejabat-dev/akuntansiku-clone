...
class AdapterHartaTetap(private val dataSet: List<HartaTetap>) :
    RecyclerView.Adapter<AdapterHartaTetap.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.recycler_harta_tetap, viewGroup, false)
