...
class AdapterHartaLancar(private val dataSet: List<HartaLancar>) :
    RecyclerView.Adapter<AdapterHartaLancar.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.recycler_harta_lancar, viewGroup, false)
